package com.win.mvvmhelper.net.interception

import android.util.Log
import com.win.mvvmhelper.net.interception.logging.DefaultFormatPrinter
import com.win.mvvmhelper.net.interception.logging.FormatPrinter
import com.win.mvvmhelper.net.interception.logging.util.CharacterHandler.Companion.jsonFormat
import com.win.mvvmhelper.net.interception.logging.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.win.mvvmhelper.net.interception.logging.util.ZipHelper.Companion.decompressForGzip
import com.win.mvvmhelper.net.interception.logging.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
